...
/**
 * Servlet implementation class MusicPassageServlet
 */
@WebServlet("/musicPassage")
public class MusicPassageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MusicPassageServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Passage> list = servicePassage.findMusicStylePassage();
