...
/**
 * Servlet implementation class BooksPassageServlet
 */
@WebServlet("/booksPassage")
public class BooksPassageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BooksPassageServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Passage> list = servicePassage.findBooksStylePassage();
		...
		request.getRequestDispatcher("/BooksPassage.jsp").forward(request, response);
	}
